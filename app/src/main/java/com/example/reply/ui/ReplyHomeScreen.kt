...
private fun ReplyAppContent(
    ...
    Box  (modifier = modifier) {
        Row {     // here the row and column is created that works different  for diffenrent activation of animation visibility.
            AnimatedVisibility(visible = navigationType == ReplyNavigationType.NAVIGATION_RAIL) {
                // here we are using the different navigation on different  cases with the help of AnimatedVisibility .
                // here if the navigation is a type of _rail this turn the visible true and implement the visibility of the navigation rail that is situated   within it's body .
                // this also prevent the implemtnaion ofthe sencond animationVIsibity .
            ...
            Column(
                ...
                AnimatedVisibility(visible =  navigationType == ReplyNavigationType.BOTTOM_NAVIGATION) {
                    // this is implemented when the navigation type is of _bottom
